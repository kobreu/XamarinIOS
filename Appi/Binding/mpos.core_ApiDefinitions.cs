...
namespace Payworks
{
	...
	interface MPTransactionParameters : INSCopying
	{
		...
		MPTransactionParameters ChargeWithAmount (NSDecimalNumber amount, NSObject currency, [NullAllowed] MPTransactionParametersOptionalsBlock optionalsBlock);
	...
	[Protocol, Model]
	interface MPExternalAccessoryOptionals : IMPAccessoryOptionals
	{
	...
	interface MPAccessoryParameters
	{
		...
		MPAccessoryParameters TcpAccessoryParametersWithFamily (NSObject family, string remote, nuint port, [NullAllowed] MPAccessoryOptionalsBlock optionalsBlock);
