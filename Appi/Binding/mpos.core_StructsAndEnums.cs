...
namespace Payworks
{
	...
	[Native]
	public enum MPReceiptLineKey : nint
	{
		Unknown,
		ReceiptType,
		TransactionType,
	...
	[Native]
	public enum MPTransactionAbortReason : nuint
	{
		MerchantAborted = 0,
		AccessoryError,
	...
	[Native]
	public enum MPErrorSource : nuint
	{
		Unknown = 0,
		Parameter,
		Accessory,
	...
	[Native]
	public enum MPTransactionStatusDetailsCode : nuint
	{
		Unknown = 0,
		InitializedAtServer,
	...
	[Native]
	public enum MPPaymentDetailsSource : nuint
	{
		Unknown = 0,
		Manual,
		Icc,
	...
	[Native]
	public enum MPPaymentDetailsScheme : nuint
	{
		Unknown = 0,
		MasterCard,
		Visa,
	...
	[Native]
	public enum MPPaymentDetailsCustomerVerification : nuint
	{
		Unknown = 0,
		None,
		Signature,
	...
	[Native]
	public enum MPRefundDetailsStatus : nuint
	{
		Unknown = 0,
		NonRefundable,
	...
	[Native]
	public enum MPRefundDetailsProcess : nuint
	{
		Unknown = 0,
		AnyCard = 1 << 0,
		WithoutCard = 1 << 1,
	...
	[Native]
	public enum MPRefundTransactionCode : nuint
	{
		Unknown = 0,
	...
	[Native]
	public enum MPPaymentAccessoryFeature : nuint
	{
		None = 0,
		MagneticStripe = 1 << 0,
		Icc = 1 << 1,
	...
	[Native]
	public enum MPPaymentAccessoryRequirement : nuint
	{
		None = 0,
	...
	[Native]
	public enum MPAccessoryUpdateRequirementStatus : nuint
	{
		NoUpdateAvailable = 0,
	...
	[Native]
	public enum MPAccessoryUpdateRequirementComponent : nuint
	{
		None = 0,
		Software = 1 << 0,
		Configuration = 1 << 1,
	...
	[Native]
	public enum MPProviderComponentDelegateDisplayUpdateType : nuint
	{
		Text = 0,
		Pin
	}
	...
	[Native]
	public enum MPAccessoryCardEvent : nuint
	{
		Unknown = 0,
		Inserted,
		Removed,
	...
	[Native]
	public enum MPAccessoryKeyEvent : nuint
	{
		Unknown = 0,
		Numeric,
		Cancel,
	...
	[Native]
	public enum MPPINInformationStatus : nuint
	{
		Started,
		Update,
		Completed,
	...
	[Native]
	public enum MPAccessoryComponentPrinterState : nuint
	{
		Unknown = 0,
		Normal,
		Busy,
	...
	[Native]
	public enum MPAccessoryComponentBarcodeScannerConfigurationBarcodeType : nuint
	{
		Unknown = 0,
		UpcEan,
		Code39,
	...
	[Native]
	public enum MPAccessoryComponentInteractionPrompt : nuint
	{
		Tip = 0,
		MobileNumber,
		TableNumber,
	...
	[Native]
	public enum MPAccessoryComponentInteractionConfirmationKey : nuint
	{
		Ok = 1 << 0,
		Cancel = 1 << 1,
		Back = 1 << 2,
	...
	[Native]
	public enum MPPrintingProcessDetailsState : nuint
	{
		Created,
		FetchingTransaction,
	...
	[Native]
	public enum MPPrintingProcessDetailsStateDetails : nuint
	{
		Created,
		FetchingTransaction,
		ConnectingToAccessory,
	...
	[Native]
	public enum MPTransactionProcessDetailsState : nuint
	{
		Created,
		ConnectingToAccessory,
		Preparing,
	...
	[Native]
	public enum MPTransactionProcessDetailsStateDetails : nuint
	{
		Created,
		ConnectingToAccessory,
	...
	[Native]
	public enum MPTransactionParametersType : nuint
	{
		Charge,
		Refund,
		Capture
